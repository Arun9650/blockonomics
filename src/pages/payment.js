  ...
  return (
    <>
      <Head>
        ...
        <script
          crossOrigin="true"
          src="https://blockonomics.co/js/pay_widget.js"
        ></script>
      </Head>

      <div className=" h-screen  bg-[#f4f5f5] text-black flex items-center flex-col justify-center border w-full">
        <Link href="/">Back</Link>
        <div className="p-5 border text-center shadow-2xl rounded-md">
        <h1 className="text-4xl p-5 pt-0 text-center  font-semibold">Payment Details </h1>
          <table class="table-fixed  min-h-max  h-2/4 w-96">
            {/* <thead>
              <tr>
                <th>Song</th>
                <th>Artist</th>
        ...
        <button id="pay" onClick={() => payment()} className="border w-full rounded-md p-2 mt-4 bg-green-500 text-white">
          Pay with Bitcoin
        </button>
...
export async function getServerSideProps({ req, res }) {
  ...
  const urlForHistory = "https://www.blockonomics.co/api/merchant_orders?limit=5"
  let a = JSON.parse(result);
